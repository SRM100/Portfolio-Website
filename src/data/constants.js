...
export const experiences = [
  {
    ...
    desc: "Tasks that I have done in KPMG are: Data Quality Assessment, Data Insights, Data Insights and Presentation",
    skills: [
      "Python",
      "Pandas",
      "Numpy",
  ...
  },
  {
    ...
    desc: "Tasks that I have completed in Cognizant are:\nExploratory Data Analysis\nData Modelling\nModel Building and Interpretation\nMachine Learning Production\nQuality Assurance",
    skills: [
      "Python",
      "linear regression",
      "Pandas",
  ...
  },
  {
    ...
    desc: "• Built a machine learning model to predict the Placement status of students based on their academic and personal details. • Used various machine learning algorithms like Logistic Regression, Decision Tree, Random Forest, and XGBoost to build the model. • Achieved an accuracy of 90% using the Random Forest algorithm.",
    skills:["python",
            "Pandas",
            "XGboost",
            "Numpy",
  ...
  },
  {
    ...
    desc: "Url-to-Article-Text-Extractor: A web application that extracts the text from the given URL and provides a summary of the article. • Implemented the web application using Flask, HTML, CSS, and JavaScript. • Used the BeautifulSoup library to extract the text from the URL. • Deployed the application on AWS.",
    skills: [
      "Python",
      "Streamlit",
      "MeautifulSoup",
...
export const education = [
...

  {
    ...
    desc: "I am completed a Bachelor's degree in Robotics and Automation Engineering Parul Institute of Technology, Vadodara. ",
